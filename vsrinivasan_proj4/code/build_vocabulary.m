...
function vocab = build_vocabulary( image_paths, vocab_size, SIFT_size, SIFT_step)
...
% visual word vocabulary.
    ...
    for ii = 1:size(image_paths,1)
        ...
        Final_SIFT_features = [Final_SIFT_features SIFT_features];
    end
    
    [centers, assignments] = vl_kmeans(single(Final_SIFT_features), vocab_size);
